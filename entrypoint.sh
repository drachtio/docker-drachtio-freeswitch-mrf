...
sed -i -e "s/<\!--<param name=\"apply-inbound-acl\" value=\"loopback.auto\"\/>-->/<param name=\"apply-inbound-acl\" value=\"loopback.auto\"\/>/g" /usr/local/freeswitch/conf/autoload_configs/event_socket.conf.xml
