...
#sed -i -e "s/<\/network-lists>/<list name=\"socket_acl\" default=\"deny\"><node type=\"allow\" cidr=\"0.0.0.0\/0\"\/><\/list><\/network-lists>/g" /usr/local/freeswitch/conf/autoload_configs/acl.conf.xml
 echo "<configuration name=\"acl.conf\" description=\"Network Lists\"><network-lists><list name=\"socket_acl\" default=\"deny\"><node type=\"allow\" cidr=\"0.0.0.0/0\"/><node type=\"allow\" cidr=\"::/0\"/></list</network-lists></configuration>" > /usr/local/freeswitch/conf/autoload_configs/acl.conf.xml
